...
public class MarkdownElementExtractorTest {
    ...
    @Test
    public void ImageAssociatorTest()
    {
        ...
        for (TextChunk chunk : result.getChunks()) {
            System.out.println("文本块: " + chunk.getContent().substring(0, Math.min(50, chunk.getContent().length())) + "...");
            System.out.println("关联图片: " + chunk.getAssociatedImages());
            System.out.println("---");
        }
    }
}
